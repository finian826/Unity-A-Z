...
public class InputsHandler : MonoBehaviour
{
		...
		private bool mobile;//mobile flag
		private bool mouseClickStarted;
		private GameObject lastClickedBtn;//last clicked button
		public GameObject[] buttons;//buttons
		public GameObject eventOb;//event object
		public string escapeEventName = "";//escape event
	
		// Use this for initialization
		void Start ()
		{
				mobile = PlatformChecker.IsAndroid () || PlatformChecker.IsIOS ();
